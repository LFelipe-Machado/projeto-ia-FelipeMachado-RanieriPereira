...
_(a preencher ao final da etapa de modelagem — seção 5.6 do notebook)_
- Baseline (previsão pela média)
- Regressão Linear
...
_(a preencher após a avaliação final — seção 5.7 do notebook)_
